...
--------------------------
IF not exists (select name from FurnishingType where Name='Fully')
insert into FurnishingType(Name, LastUpdatedOn, LastUpdatedBy)
select 'Fully', GETDATE(),@UserID

IF not exists (select name from FurnishingType where Name='Semi')
insert into FurnishingType(Name, LastUpdatedOn, LastUpdatedBy)
select 'Semi', GETDATE(),@UserID

IF not exists (select name from FurnishingType where Name='Unfurnished')
insert into FurnishingType(Name, LastUpdatedOn, LastUpdatedBy)
...
2, --BHK
(select Id from FurnishingType where Name='Fully'), --Furnishing Type ID
1800, --Price
1400, --Built Area
900, --Carpet Area
'6 Street', --Address
...
delete from FurnishingType where LastUpdatedBy=@UserID
